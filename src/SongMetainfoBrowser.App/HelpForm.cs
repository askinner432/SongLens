...
public sealed class HelpForm : Form
{
    ...
    private static string[] BuildHelpLines()
    {
        ...
        [
            ...
            "- Use Filter By Date above the Song Grid to show all songs, filter by age in days, or filter between two Created or Modified dates. Select Display filter results in the Song Grid to list every matching song together.",
            ...
            "- Use Tools > Preferences > Appearance > Adjust Visible Tabs if you want to hide detail tabs you do not use often.",
            ...
            "- When the Song Grid contains multiple songs, Snapshot Results captures the visible columns, their display order, the current sort order, and every visible row.",
            "",
            "Recently Viewed",
